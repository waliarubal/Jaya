...
namespace Jaya.Ui
{
    ...
    {
        public DirectoryChangedEventArgs(ProviderServiceBase service, AccountModelBase provider, DirectoryModel directory, NavigationDirection direction = NavigationDirection.Unknown)
        {
            Service = service;
            Provider = provider;
            Directory = directory;
