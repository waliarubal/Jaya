...
EXEC dotnet publish -c Release -r win-x64 --self-contained true --output %OUTPUT_DIR%   
EXEC %7Z% a -tzip %OUTPUT% %OUTPUT_DIR%/*
...
EXEC dotnet publish -c Release -r linux-x64 --self-contained true --output %OUTPUT_DIR%
EXEC %7Z% a -tzip %OUTPUT% %OUTPUT_DIR%/*
...
EXEC dotnet publish -c Release -r osx-x64 --self-contained true --output %OUTPUT_DIR%    
EXEC %7Z% a -tzip %OUTPUT% %OUTPUT_DIR%/*